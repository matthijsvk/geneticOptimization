...
if runPossible
    startTime = cputime;
    results = sweepParameterValues(nbRunsAvg, PValues, sdMutValues, sdMutRec, NValues, NPMult, NCMult, intervalValues, totalNbTests, V, M, lb, ub);
 ...
 function results = sweepParameterValues(nbRunsAvg, PValues, sdMutValues, sdMutRec, NValues, NPMult, NCMult,  intervalValues, totalNbTests, V, M, lb, ub)
 results = zeros(totalNbTests,16); %columns: P, sdMut, N, NP, NC, intervalValue avgTime, avgIt
i=1;
            ...
            for NPindex=1:length(NPMult)
                ...
                for NCindex=1:length(NCMult)
                    ...
                    for intervalIndex=1:length(intervalValues)
                        ...
                        results(i,:) = [P, sdMut, N, NP, NC, intervalValue, itAvg, runTimeAvg ,itMed, runTimeMed, itMax, runTimeMax, itMin, runTimeMin, itStd, runTimeStd];
                        disp(results(i,:))
                        i = i +1;
