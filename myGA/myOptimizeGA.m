...
%               P sd_mut  N     NP   NC   intervalScalar score rank crowding
population= [   0.5, 0.1,  20,  0.5, 0.95, 1.3;
                0.8, 0.3,  28,  0.8, 1.3,  1.1;
                0.6, 0.05, 12,  1,   0.65, 1.5;
                0.3, 0.15, 30,  0.8, 0.9,  1.2];
...
%     end
    ...
    [stopFlag, crowdingDistanceFlag] = stopCriterion(it, population(:,V+M+1),population, V+M+2, N, M);%oldPopulationObjectives, population(:,V+1:V+M), notChangingLimit, V, M);
    it=it+1;
