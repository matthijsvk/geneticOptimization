...
%P=0.49658  ;sd_mut= 0.18563; sd_mut_rec=1e-05 ; Nbase=24   ;N=round(Nbase);NP=round(N*0.90489);NC=round(N*1.4831);
P= 0.5 ; sd_mut=0.2 ; sd_mut_rec= 0.001 ; Nbase = 20; N=round(Nbase);NP=round(0.5*Nbase); NC=round(N*0.95);% should be 0.0835*20 = 1.67s

%0.49658            2        1e-05            8      0.90489       1.4831
